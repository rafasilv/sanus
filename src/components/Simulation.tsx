          ...
          >
            <Card className="h-full opacity-60 cursor-not-allowed">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-muted-foreground">Simule sua linha de crédito</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          >
            <Card className="h-full opacity-60 cursor-not-allowed">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-muted-foreground">Planeje seu investimento</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4 text-muted-foreground">
